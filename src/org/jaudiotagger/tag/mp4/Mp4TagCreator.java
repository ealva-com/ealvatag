...
public class Mp4TagCreator extends AbstractTagCreator
{
    ...
    public ByteBuffer convert(Tag tag, int padding) throws UnsupportedEncodingException
    {
        try
        {
            ...
            while (it.hasNext())
            {
                ...
                if (frame instanceof Mp4TagCoverField)
                {
                    ...
                    else
                    {
                        ...
                        baos.write(Utils.getDefaultBytes(Mp4FieldKey.ARTWORK.getFieldName(), StandardCharsets.ISO_8859_1));
                        baos.write(data);
                    }
                }
                else
            ...
            ilst.write(Utils.getDefaultBytes(Mp4AtomIdentifier.ILST.getFieldName(), StandardCharsets.ISO_8859_1));
