...
public enum Mp4FieldKey
{
    ...
    SOLOIST("com.apple.iTunes","SOLOIST",  TEXT, Tagger.JAIKOZ),
    WORK_TYPE("com.apple.iTunes","WORK TYPE",  TEXT, Tagger.JAIKOZ),
    MUSICBRAINZ_WORK_COMPOSITION_ID("com.apple.iTunes","MusicBrainz Work Composition Id",  TEXT, Tagger.JAIKOZ),
    WORK_COMPOSITION("com.apple.iTunes","Work Composition",  TEXT, Tagger.JAIKOZ),
    WORK_COMPOSITION_TYPE("com.apple.iTunes","Work Composition Type",  TEXT, Tagger.JAIKOZ),
    MUSICBRAINZ_WORK_PARTOF_LEVEL1_ID("com.apple.iTunes","MusicBrainz Work PartofLevel1 Id",  TEXT, Tagger.JAIKOZ),
    WORK_PARTOF_LEVEL1("com.apple.iTunes","Work PartofLevel1",  TEXT, Tagger.JAIKOZ),
    WORK_PARTOF_LEVEL1_TYPE("com.apple.iTunes","Work PartofLevel1 Type",  TEXT, Tagger.JAIKOZ),
    MUSICBRAINZ_WORK_PARTOF_LEVEL2_ID("com.apple.iTunes","MusicBrainz Work PartofLevel2 Id",  TEXT, Tagger.JAIKOZ),
    WORK_PARTOF_LEVEL2("com.apple.iTunes","Work PartofLevel2",  TEXT, Tagger.JAIKOZ),
    WORK_PARTOF_LEVEL2_TYPE("com.apple.iTunes","Work PartofLevel2 Type",  TEXT, Tagger.JAIKOZ),
    MUSICBRAINZ_WORK_PARTOF_LEVEL3_ID("com.apple.iTunes","MusicBrainz Work PartofLevel3 Id",  TEXT, Tagger.JAIKOZ),
    WORK_PARTOF_LEVEL3("com.apple.iTunes","Work PartofLevel3",  TEXT, Tagger.JAIKOZ),
    WORK_PARTOF_LEVEL3_TYPE("com.apple.iTunes","Work PartofLevel3 Type",  TEXT, Tagger.JAIKOZ),
    MUSICBRAINZ_WORK_PARTOF_LEVEL4_ID("com.apple.iTunes","MusicBrainz Work PartofLevel4 Id",  TEXT, Tagger.JAIKOZ),
    WORK_PARTOF_LEVEL4("com.apple.iTunes","Work PartofLevel4",  TEXT, Tagger.JAIKOZ),
    WORK_PARTOF_LEVEL4_TYPE("com.apple.iTunes","Work PartofLevel4 Type",  TEXT, Tagger.JAIKOZ),
    MUSICBRAINZ_WORK_PARTOF_LEVEL5_ID("com.apple.iTunes","MusicBrainz Work PartofLevel5 Id",  TEXT, Tagger.JAIKOZ),
    WORK_PARTOF_LEVEL5("com.apple.iTunes","Work PartofLevel5",  TEXT, Tagger.JAIKOZ),
    WORK_PARTOF_LEVEL5_TYPE("com.apple.iTunes","Work PartofLevel5 Type",  TEXT, Tagger.JAIKOZ),
