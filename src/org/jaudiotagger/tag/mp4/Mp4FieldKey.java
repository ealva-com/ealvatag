...
public enum Mp4FieldKey
{
    ...
    MOVEMENT("com.apple.iTunes", "MOVEMENT", TEXT, Tagger.JAIKOZ),
    MOVEMENT_NO("com.apple.iTunes", "MOVEMENT_NO", TEXT, Tagger.JAIKOZ),
    MOVEMENT_TOTAL("com.apple.iTunes", "MOVEMENT_TOTAL", TEXT, Tagger.JAIKOZ),
