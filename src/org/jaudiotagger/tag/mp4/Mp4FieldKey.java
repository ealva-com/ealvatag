...
public enum Mp4FieldKey
{
    ...
    MUSICBRAINZ_WORK_PART_LEVEL0_ID("com.apple.iTunes","MusicBrainz Work Part Level0 Id",  TEXT, Tagger.JAIKOZ),
    ...
    NON_SOLOIST("com.apple.iTunes","Non Soloist",  TEXT, Tagger.JAIKOZ),
