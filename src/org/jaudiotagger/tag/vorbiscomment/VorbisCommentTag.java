...
public class VorbisCommentTag extends AbstractTag
{
    ...
    static
    {
        ...
        tagFieldToOggField.put(FieldKey.WORK_COMPOSITION_NAME, VorbisCommentFieldKey.WORK_COMPOSITION_NAME);
        tagFieldToOggField.put(FieldKey.WORK_PART_LEVEL1, VorbisCommentFieldKey.WORK_PART_LEVEL1_NAME);
        tagFieldToOggField.put(FieldKey.WORK_PART_LEVEL1_TYPE, VorbisCommentFieldKey.WORK_PART_LEVEL1_TYPE);
        tagFieldToOggField.put(FieldKey.WORK_PART_LEVEL2, VorbisCommentFieldKey.WORK_PART_LEVEL2_NAME);
        tagFieldToOggField.put(FieldKey.WORK_PART_LEVEL2_TYPE, VorbisCommentFieldKey.WORK_PART_LEVEL2_TYPE);
        tagFieldToOggField.put(FieldKey.WORK_PART_LEVEL3, VorbisCommentFieldKey.WORK_PART_LEVEL3_NAME);
        tagFieldToOggField.put(FieldKey.WORK_PART_LEVEL3_TYPE, VorbisCommentFieldKey.WORK_PART_LEVEL3_TYPE);
        tagFieldToOggField.put(FieldKey.WORK_PART_LEVEL4, VorbisCommentFieldKey.WORK_PART_LEVEL4_NAME);
        tagFieldToOggField.put(FieldKey.WORK_PART_LEVEL4_TYPE, VorbisCommentFieldKey.WORK_PART_LEVEL4_TYPE);
        tagFieldToOggField.put(FieldKey.WORK_PART_LEVEL5, VorbisCommentFieldKey.WORK_PART_LEVEL5_NAME);
        tagFieldToOggField.put(FieldKey.WORK_PART_LEVEL5_TYPE, VorbisCommentFieldKey.WORK_PART_LEVEL5_TYPE);
        tagFieldToOggField.put(FieldKey.WORK_PART_LEVEL6, VorbisCommentFieldKey.WORK_PART_LEVEL6_NAME);
