...
public enum VorbisCommentFieldKey
{
    ...
    MUSICBRAINZ_WORK_PARTOF_LEVEL0_ID("MUSICBRAINZ_WORK_PART_LEVEL0_ID",EnumSet.of(Tagger.JAIKOZ)),
    MUSICBRAINZ_WORK_PARTOF_LEVEL1_ID("MUSICBRAINZ_WORK_PART_LEVEL1_ID",EnumSet.of(Tagger.JAIKOZ)),
    ...
    PERFORMIMG_ARTIST("PERFORMING_ARTIST",EnumSet.of(Tagger.JAIKOZ)),
    PERFORMING_ARTIST_SORT("PERFORMING_ARTIST_SORT",EnumSet.of(Tagger.JAIKOZ)),
    PERFORMING_SOLOIST("PERFORMING_SOLOIST",EnumSet.of(Tagger.JAIKOZ)),
    PERFORMING_SOLOIST_SORT("PERFORMING_SOLOIST_SORT",EnumSet.of(Tagger.JAIKOZ)),
    ...
    WORK_PART_LEVEL3_NAME("WORK_PART_LEVEL3",EnumSet.of(Tagger.JAIKOZ)),
    WORK_PART_LEVEL3_TYPE("WORK_PART_LEVEL3_TYPE",EnumSet.of(Tagger.JAIKOZ)),
    WORK_PART_LEVEL4_NAME("WORK_PART_LEVEL4",EnumSet.of(Tagger.JAIKOZ)),
    WORK_PART_LEVEL4_TYPE("WORK_PART_LEVEL4_TYPE",EnumSet.of(Tagger.JAIKOZ)),
    WORK_PART_LEVEL5_NAME("WORK_PART_LEVEL5",EnumSet.of(Tagger.JAIKOZ)),
    WORK_PART_LEVEL5_TYPE("WORK_PART_LEVEL5_TYPE",EnumSet.of(Tagger.JAIKOZ)),
    WORK_PART_LEVEL6_NAME("WORK_PART_LEVEL6",EnumSet.of(Tagger.JAIKOZ)),
