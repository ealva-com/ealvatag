...
public enum VorbisCommentFieldKey
{
    ...
    SOLOIST("SOLOIST",EnumSet.of(Tagger.JAIKOZ)),
    ...
    WORK_COMPOSITION_NAME("WORK_COMPOSITION",EnumSet.of(Tagger.JAIKOZ)),
    WORK_COMPOSITION_TYPE("WORK_COMPOSITION_TYPE",EnumSet.of(Tagger.JAIKOZ)),
    MUSICBRAINZ_WORK_PARTOF_LEVEL1_ID("MUSICBRAINZ_WORK_PARTOF_LEVEL1_ID",EnumSet.of(Tagger.JAIKOZ)),
    WORK_PARTOF_LEVEL1_NAME("WORK_PARTOF_LEVEL1",EnumSet.of(Tagger.JAIKOZ)),
    WORK_PARTOF_LEVEL1_TYPE("WORK_PARTOF_LEVEL1_TYPE",EnumSet.of(Tagger.JAIKOZ)),
    MUSICBRAINZ_WORK_PARTOF_LEVEL2_ID("MUSICBRAINZ_WORK_PARTOF_LEVEL2_ID",EnumSet.of(Tagger.JAIKOZ)),
    WORK_PARTOF_LEVEL2_NAME("WORK_PARTOF_LEVEL2",EnumSet.of(Tagger.JAIKOZ)),
    WORK_PARTOF_LEVEL2_TYPE("WORK_PARTOF_LEVEL2_TYPE",EnumSet.of(Tagger.JAIKOZ)),
    MUSICBRAINZ_WORK_PARTOF_LEVEL3_ID("MUSICBRAINZ_WORK_PARTOF_LEVEL3_ID",EnumSet.of(Tagger.JAIKOZ)),
    WORK_PARTOF_LEVEL3_NAME("WORK_PARTOF_LEVEL3",EnumSet.of(Tagger.JAIKOZ)),
    WORK_PARTOF_LEVEL3_TYPE("WORK_PARTOF_LEVEL3_TYPE",EnumSet.of(Tagger.JAIKOZ)),
    MUSICBRAINZ_WORK_PARTOF_LEVEL4_ID("MUSICBRAINZ_WORK_PARTOF_LEVEL4_ID",EnumSet.of(Tagger.JAIKOZ)),
    WORK_PARTOF_LEVEL4_NAME("WORK_PARTOF_LEVEL4",EnumSet.of(Tagger.JAIKOZ)),
    WORK_PARTOF_LEVEL4_TYPE("WORK_PARTOF_LEVEL4_TYPE",EnumSet.of(Tagger.JAIKOZ)),
    MUSICBRAINZ_WORK_PARTOF_LEVEL5_ID("MUSICBRAINZ_WORK_PARTOF_LEVEL5_ID",EnumSet.of(Tagger.JAIKOZ)),
    WORK_PARTOF_LEVEL5_NAME("WORK_PARTOF_LEVEL5",EnumSet.of(Tagger.JAIKOZ)),
    WORK_PARTOF_LEVEL5_TYPE("WORK_PARTOF_LEVEL5_TYPE",EnumSet.of(Tagger.JAIKOZ)),
    MUSICBRAINZ_WORK_PARTOF_LEVEL6_ID("MUSICBRAINZ_WORK_PARTOF_LEVEL6_ID",EnumSet.of(Tagger.JAIKOZ)),
    WORK_PARTOF_LEVEL6_NAME("WORK_PARTOF_LEVEL6",EnumSet.of(Tagger.JAIKOZ)),
    WORK_PARTOF_LEVEL6_TYPE("WORK_PARTOF_LEVEL6_TYPE",EnumSet.of(Tagger.JAIKOZ)),
    ;
