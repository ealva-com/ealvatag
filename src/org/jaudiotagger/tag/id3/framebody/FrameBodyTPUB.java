...
public class FrameBodyTPUB extends AbstractFrameBodyTextInfo implements ID3v24FrameBody
{
    /**
     ...
     */
    public FrameBodyTPUB(java.io.RandomAccessFile file, int frameSize)
