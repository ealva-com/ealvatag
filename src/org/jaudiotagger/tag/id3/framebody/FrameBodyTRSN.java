...
public class FrameBodyTRSN extends AbstractFrameBodyTextInfo implements ID3v24FrameBody
{
    /**
     ...
     */
    public FrameBodyTRSN(java.io.RandomAccessFile file, int frameSize)
