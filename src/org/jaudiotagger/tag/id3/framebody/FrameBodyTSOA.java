...
public class FrameBodyTSOA extends AbstractFrameBodyTextInfo implements ID3v24FrameBody
{
    /**
     ...
     */
    public FrameBodyTSOA(java.io.RandomAccessFile file, int frameSize)
