...
public class FrameBodyTDAT extends AbstractFrameBodyTextInfo implements ID3v24FrameBody
{
    /**
     ...
     */
    public FrameBodyTDAT(java.io.RandomAccessFile file, int frameSize)
