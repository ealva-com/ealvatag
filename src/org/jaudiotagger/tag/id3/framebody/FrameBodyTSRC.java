...
public class FrameBodyTSRC extends AbstractFrameBodyTextInfo implements ID3v24FrameBody
{
    /**
     ...
     */
    public FrameBodyTSRC(java.io.RandomAccessFile file, int frameSize)
