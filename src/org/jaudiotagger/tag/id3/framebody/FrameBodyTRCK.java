...
public class FrameBodyTRCK extends AbstractFrameBodyTextInfo implements ID3v24FrameBody
{
    /**
     ...
     */
    public FrameBodyTRCK(java.io.RandomAccessFile file, int frameSize)
