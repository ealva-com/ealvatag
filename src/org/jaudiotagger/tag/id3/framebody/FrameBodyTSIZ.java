...
public class FrameBodyTSIZ extends AbstractFrameBodyTextInfo  implements ID3v24FrameBody
{
    /**
     ...
     */
    public FrameBodyTSIZ(java.io.RandomAccessFile file, int frameSize)
