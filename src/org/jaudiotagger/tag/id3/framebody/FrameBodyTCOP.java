...
public class FrameBodyTCOP extends AbstractFrameBodyTextInfo implements ID3v24FrameBody
{
    /**
     ...
     */
    public FrameBodyTCOP(java.io.RandomAccessFile file, int frameSize)
