...
public class FrameBodyTBPM extends AbstractFrameBodyTextInfo implements ID3v24FrameBody
{
    /**
     ...
     */
    public FrameBodyTBPM(java.io.RandomAccessFile file, int frameSize)
