...
public class FrameBodyTCOM extends AbstractFrameBodyTextInfo implements ID3v24FrameBody
{
    /**
     ...
     */
    public FrameBodyTCOM(java.io.RandomAccessFile file, int frameSize)
