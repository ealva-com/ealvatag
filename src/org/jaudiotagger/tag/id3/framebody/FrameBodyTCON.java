...
public class FrameBodyTCON extends AbstractFrameBodyTextInfo implements ID3v24FrameBody
{
    /**
     ...
     */
    public FrameBodyTCON(java.io.RandomAccessFile file, int frameSize)
