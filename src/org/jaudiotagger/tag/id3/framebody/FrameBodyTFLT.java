...
public class FrameBodyTFLT extends AbstractFrameBodyTextInfo implements ID3v24FrameBody
{
    /**
     ...
     */
    public FrameBodyTFLT(java.io.RandomAccessFile file, int frameSize)
