 ...
 *
 */
public class FrameBodyTMCL extends AbstractID3v2FrameBody implements ID3v24FrameBody
{
     ...
     * @param name
     */
    public void addPair(String instrument,String name)
    {
