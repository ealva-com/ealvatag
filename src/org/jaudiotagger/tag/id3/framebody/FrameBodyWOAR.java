...
public class FrameBodyWOAR extends AbstractFrameBodyUrlLink  implements ID3v24FrameBody
{
    /**
     ...
     */
    public FrameBodyWOAR(java.io.RandomAccessFile file, int frameSize)
