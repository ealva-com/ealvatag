...
public class FrameBodyWCOP extends AbstractFrameBodyUrlLink implements ID3v24FrameBody
{
    /**
     ...
     */
    public FrameBodyWCOP(java.io.RandomAccessFile file, int frameSize)
