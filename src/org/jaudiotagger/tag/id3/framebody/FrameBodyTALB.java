...
public class FrameBodyTALB extends AbstractFrameBodyTextInfo implements ID3v24FrameBody
{
    /**
     ...
     */
    public FrameBodyTALB(java.io.RandomAccessFile file, int frameSize)
