...
public class FrameBodyTDLY extends AbstractFrameBodyTextInfo implements ID3v24FrameBody
{
    /**
     ...
     */
    public FrameBodyTDLY(java.io.RandomAccessFile file, int frameSize)
