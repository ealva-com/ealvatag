...
public class FrameBodyWORS extends AbstractFrameBodyUrlLink implements ID3v24FrameBody
{
    /**
     ...
     */
    public FrameBodyWORS(java.io.RandomAccessFile file, int frameSize)
