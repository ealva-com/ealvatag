...
public class FrameBodyTIME extends AbstractFrameBodyTextInfo implements ID3v24FrameBody
{
    /**
     ...
     */
    public FrameBodyTIME(java.io.RandomAccessFile file, int frameSize)
