...
public class FrameBodyTEXT extends AbstractFrameBodyTextInfo implements ID3v24FrameBody
{
    /**
     ...
     */
    public FrameBodyTEXT(java.io.RandomAccessFile file, int frameSize)
