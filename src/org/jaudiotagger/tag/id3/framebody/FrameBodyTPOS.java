...
public class FrameBodyTPOS extends AbstractFrameBodyTextInfo implements ID3v24FrameBody
{
    /**
     ...
     */
    public FrameBodyTPOS(java.io.RandomAccessFile file, int frameSize)
