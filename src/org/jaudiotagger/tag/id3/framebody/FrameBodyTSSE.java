...
public class FrameBodyTSSE extends AbstractFrameBodyTextInfo implements ID3v24FrameBody
{
    /**
     ...
     */
    public FrameBodyTSSE(java.io.RandomAccessFile file, int frameSize)
