...
public class FrameBodyWOAF extends AbstractFrameBodyUrlLink implements ID3v24FrameBody
{
    /**
     ...
     */
    public FrameBodyWOAF(java.io.RandomAccessFile file, int frameSize)
