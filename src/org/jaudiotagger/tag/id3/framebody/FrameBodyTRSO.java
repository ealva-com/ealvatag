...
public class FrameBodyTRSO extends AbstractFrameBodyTextInfo implements ID3v24FrameBody
{
    /**
     ...
     */
    public FrameBodyTRSO(java.io.RandomAccessFile file, int frameSize)
