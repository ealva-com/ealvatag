...
public class ID3v24Frames extends ID3Frames
{
    ...
    private ID3v24Frames()
    {
        ...
        tagFieldToId3.put(FieldKey.MUSICBRAINZ_WORK_PART_LEVEL0_ID, ID3v24FieldKey.MUSICBRAINZ_WORK_PARTOF_LEVEL0_ID);
        tagFieldToId3.put(FieldKey.MUSICBRAINZ_WORK_PART_LEVEL1_ID, ID3v24FieldKey.MUSICBRAINZ_WORK_PARTOF_LEVEL1_ID);
        ...
        tagFieldToId3.put(FieldKey.NON_SOLOIST, ID3v24FieldKey.NON_SOLOIST);
        tagFieldToId3.put(FieldKey.NON_SOLOIST_SORT, ID3v24FieldKey.NON_SOLOIST_SORT);
