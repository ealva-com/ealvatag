...
public class ID3v23Frames extends ID3Frames
{
    ...
    public static final String FRAME_ID_V3_ALBUM_SORT_ORDER = "TSOA";
    ...
    public static final String FRAME_ID_V3_AUDIO_SEEK_POINT_INDEX = "ASPI";
    ...
    public static final String FRAME_ID_V3_ENCODING_TIME = "TDEN";
    ...
    public static final String FRAME_ID_V3_PERFORMER_SORT_OWNER = "TSOP";
    ...
    public static final String FRAME_ID_V3_PRODUCED_NOTICE = "TPRO";
    ...
    public static final String FRAME_ID_V3_TITLE_SORT_OWNER = "TSOT";
    ...
    public static final String FRAME_ID_V3_YEAR = "TDRC";

    //V3 Additional Frames not covered by V4.
    public static final String FRAME_ID_V3_EQUA = "EQUA";
    public static final String FRAME_ID_V3_IPLS = "IPLS";
    public static final String FRAME_ID_V3_RVAD = "RVAD";
    ...
    private ID3v23Frames()
    {
        ...
        discardIfFileAlteredFrames.add(FRAME_ID_V3_EQUA);
        ...
        discardIfFileAlteredFrames.add(FRAME_ID_V3_RVAD);
        discardIfFileAlteredFrames.add(FRAME_ID_V3_EVENT_TIMING_CODES);
