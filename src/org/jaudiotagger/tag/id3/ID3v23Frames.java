...
public class ID3v23Frames extends ID3Frames
{
    ...
    private ID3v23Frames()
    {
        ...
        tagFieldToId3.put(FieldKey.MUSICIAN, ID3v23FieldKey.MUSICIAN);
        ...
        tagFieldToId3.put(FieldKey.MUSICBRAINZ_WORK_PART_LEVEL0_ID, ID3v23FieldKey.MUSICBRAINZ_WORK_PART_LEVEL0_ID);
