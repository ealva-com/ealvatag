...
public class ChannelTypes extends AbstractIntStringValuePair
{
    ...
    private ChannelTypes()
    {
        ...
        idToValue.put(new Integer(0x01), "Master volume");
        idToValue.put(new Integer(0x02), "Front right");
        idToValue.put(new Integer(0x03), "Front left");
        idToValue.put(new Integer(0x04), "Back right");
        idToValue.put(new Integer(0x05), "Back left");
        idToValue.put(new Integer(0x06), "Front centre");
        idToValue.put(new Integer(0x07), "Back centre");
        idToValue.put(new Integer(0x08), "Subwoofer");
