...
public class MusicianCredits
{
    ...
    static
    {
        ...
        musicianCredits.add("acoustic bass guitar");
        musicianCredits.add("acoustic fretless guitar");
        musicianCredits.add("acoustic guitar");
        ...
        musicianCredits.add("alto clarinet");
        musicianCredits.add("alto flute");
        musicianCredits.add("alto saxophone");
        musicianCredits.add("alto violin");
        musicianCredits.add("alto vocals");
        ...
        musicianCredits.add("baritone guitar");
        musicianCredits.add("baritone horn");
        musicianCredits.add("baritone saxophone");
        musicianCredits.add("baritone vocals");
        musicianCredits.add("baroque trumpet");
        musicianCredits.add("barrel drum");
        musicianCredits.add("barrel organ");
        musicianCredits.add("baryton");
        musicianCredits.add("bass");
        musicianCredits.add("bass-baritone vocals");
        musicianCredits.add("bass clarinet");
        musicianCredits.add("bass drum");
        musicianCredits.add("basset clarinet");
        musicianCredits.add("basset horn");
        musicianCredits.add("bass flute");
        musicianCredits.add("bass guitar");
        musicianCredits.add("bass harmonica");
        musicianCredits.add("bass oboe");
        musicianCredits.add("bassoon");
        musicianCredits.add("bass pedals");
        musicianCredits.add("bass recorder");
        musicianCredits.add("bass saxophone");
        musicianCredits.add("bass synthesizer");
        musicianCredits.add("bass trombone");
        musicianCredits.add("bass trumpet");
        musicianCredits.add("bass vocals");
        ...
        musicianCredits.add("chamber organ");
        ...
        musicianCredits.add("choir vocals");
        ...
        musicianCredits.add("piano accordion");
        musicianCredits.add("piano spinet");
        musicianCredits.add("piccolo");
        musicianCredits.add("piccolo oboe");
        musicianCredits.add("piccolo trumpet");
        ...
        musicianCredits.add("slide brass instruments");
        musicianCredits.add("slide guitar");
        musicianCredits.add("slide whistle");
        ...
        musicianCredits.add("sopranino recorder");
        musicianCredits.add("sopranino saxophone");
        musicianCredits.add("soprano clarinet");
        musicianCredits.add("soprano flute");
        musicianCredits.add("soprano saxophone");
        musicianCredits.add("soprano violin");
        musicianCredits.add("soprano vocals");
        musicianCredits.add("sousaphone");
        musicianCredits.add("spanish acoustic guitar");
        musicianCredits.add("spanish vihuela");
        ...
        musicianCredits.add("tenor banjo");
        musicianCredits.add("tenor guitar");
        musicianCredits.add("tenor horn / alto horn");
        musicianCredits.add("tenor recorder");
        musicianCredits.add("tenor saxophone");
        musicianCredits.add("tenor trombone");
        musicianCredits.add("tenor violin");
        musicianCredits.add("tenor vocals");
        ...
        musicianCredits.add("treble flute");
        musicianCredits.add("treble recorder / alto recorder");
        musicianCredits.add("treble violin");
        musicianCredits.add("treble vocals");
        ...
        musicianCredits.add("video");
        musicianCredits.add("vielle");
        musicianCredits.add("vienna horn");
        musicianCredits.add("vietnamese guitar");
        musicianCredits.add("viola");
        musicianCredits.add("viola caipira");
        musicianCredits.add("viola da gamba");
        musicianCredits.add("viola d'amore");
        musicianCredits.add("viola organista");
        musicianCredits.add("violin");
        musicianCredits.add("violino piccolo");
        musicianCredits.add("violins");
