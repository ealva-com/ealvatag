...
public enum ID3v24FieldKey
{
    ...
    PERFORMING_SOLOIST(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.PERFORMING_SOLOIST, Id3FieldType.TEXT),
    WORK_TYPE(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.WORK_TYPE, Id3FieldType.TEXT),
    MUSICBRAINZ_WORK_PARTOF_LEVEL0_ID(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.MUSICBRAINZ_WORK_PART_LEVEL0_ID, Id3FieldType.TEXT),
    PART_TYPE(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.PART_TYPE, Id3FieldType.TEXT),
    MUSICBRAINZ_WORK_PARTOF_LEVEL1_ID(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.MUSICBRAINZ_WORK_PART_LEVEL1_ID, Id3FieldType.TEXT),
    ...
    PERFORMING_SOLOIST_SORT(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.PERFORMING_SOLOIST_SORT, Id3FieldType.TEXT),
    ORCHESTRA_SORT(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.ORCHESTRA_SORT, Id3FieldType.TEXT),
    PERFORMING_ARTIST(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.PERFORMING_ARTIST, Id3FieldType.TEXT),
    PERFORMING_ARTIST_SORT(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.PERFORMING_ARTIST_SORT, Id3FieldType.TEXT),
