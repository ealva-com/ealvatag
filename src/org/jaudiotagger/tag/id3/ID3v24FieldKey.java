...
public enum ID3v24FieldKey
{
    ...
    SOLOIST(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.SOLOIST, Id3FieldType.TEXT),
    ...
    WORK_COMPOSITION_TYPE(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.WORK_COMPOSITION_TYPE, Id3FieldType.TEXT),
    MUSICBRAINZ_WORK_PARTOF_LEVEL1_ID(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.MUSICBRAINZ_WORK_PARTOF_LEVEL1_ID, Id3FieldType.TEXT),
    WORK_PARTOF_LEVEL1(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.WORK_PARTOF_LEVEL1, Id3FieldType.TEXT),
    WORK_PARTOF_LEVEL1_TYPE(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.WORK_PARTOF_LEVEL1_TYPE, Id3FieldType.TEXT),
    MUSICBRAINZ_WORK_PARTOF_LEVEL2_ID(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.MUSICBRAINZ_WORK_PARTOF_LEVEL2_ID, Id3FieldType.TEXT),
    WORK_PARTOF_LEVEL2(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.WORK_PARTOF_LEVEL2, Id3FieldType.TEXT),
    WORK_PARTOF_LEVEL2_TYPE(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.WORK_PARTOF_LEVEL2_TYPE, Id3FieldType.TEXT),
    MUSICBRAINZ_WORK_PARTOF_LEVEL3_ID(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.MUSICBRAINZ_WORK_PARTOF_LEVEL3_ID, Id3FieldType.TEXT),
    WORK_PARTOF_LEVEL3(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.WORK_PARTOF_LEVEL3, Id3FieldType.TEXT),
    WORK_PARTOF_LEVEL3_TYPE(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.WORK_PARTOF_LEVEL3_TYPE, Id3FieldType.TEXT),
    MUSICBRAINZ_WORK_PARTOF_LEVEL4_ID(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.MUSICBRAINZ_WORK_PARTOF_LEVEL4_ID, Id3FieldType.TEXT),
    WORK_PARTOF_LEVEL4(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.WORK_PARTOF_LEVEL4, Id3FieldType.TEXT),
    WORK_PARTOF_LEVEL4_TYPE(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.WORK_PARTOF_LEVEL4_TYPE, Id3FieldType.TEXT),
    MUSICBRAINZ_WORK_PARTOF_LEVEL5_ID(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.MUSICBRAINZ_WORK_PARTOF_LEVEL5_ID, Id3FieldType.TEXT),
    WORK_PARTOF_LEVEL5(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.WORK_PARTOF_LEVEL5, Id3FieldType.TEXT),
    WORK_PARTOF_LEVEL5_TYPE(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.WORK_PARTOF_LEVEL5_TYPE, Id3FieldType.TEXT),
    MUSICBRAINZ_WORK_PARTOF_LEVEL6_ID(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.MUSICBRAINZ_WORK_PARTOF_LEVEL6_ID, Id3FieldType.TEXT),
    WORK_PARTOF_LEVEL6(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.WORK_PARTOF_LEVEL6, Id3FieldType.TEXT),
    WORK_PARTOF_LEVEL6_TYPE(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.WORK_PARTOF_LEVEL6_TYPE, Id3FieldType.TEXT),
    ...
    SOLOIST_SORT(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.SOLOIST_SORT, Id3FieldType.TEXT),
    ORCHESTRA_SORT(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.ORCHESTRA_SORT, Id3FieldType.TEXT),
    PERFORMER_SORT(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.PERFORMER_SORT, Id3FieldType.TEXT),
