...
public enum ID3v24FieldKey
{
    ...
    NON_SOLOIST(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.NON_SOLOIST, Id3FieldType.TEXT),
    NON_SOLOIST_SORT(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO, FrameBodyTXXX.NON_SOLOIST_SORT, Id3FieldType.TEXT),
