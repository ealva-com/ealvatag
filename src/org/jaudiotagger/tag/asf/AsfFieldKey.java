...
public enum AsfFieldKey
{
    ...
    ALBUM_ARTISTS("WM/ALBUM_ARTISTS", true),
    ALBUM_ARTISTS_SORT("WM/ALBUM_ARTISTS_SORT", true),
    ...
    CLASSICAL_NICKNAME("WM/CLASSICAL_NICKNAME", true),
    ...
    MOVEMENT("WM/Movement", false),
    MOVEMENT_NO("WM/MovementNumber", false),
    MOVEMENT_TOTAL("WM/MovementTotal", false),
    ...
    MUSICBRAINZ_WORK_COMPOSITION("WM/MUSICBRAINZ_WORK_COMPOSITION",true),
