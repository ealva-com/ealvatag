...
public class DirectByteBufferUtils {
	...
	public static void release(Buffer bb) {
		...
		if(bb==null) throw new NullPointerException(ByteBuffer.class.getSimpleName() + " should not be null");
		if(!bb.isDirect()) throw new IllegalArgumentException(bb.getClass().getName() + " is not direct.");
