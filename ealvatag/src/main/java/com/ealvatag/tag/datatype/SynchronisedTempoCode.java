 ...
 */
package com.ealvatag.tag.datatype;

import com.ealvatag.tag.InvalidDataTypeException;
import com.ealvatag.tag.id3.AbstractTagFrameBody;
import com.ealvatag.tag.id3.valuepair.EventTimingTypes;

/**
 * A single synchronized tempo code. Part of a list of temnpo codes ({@link com.ealvatag.tag.datatype.SynchronisedTempoCodeList}), that are contained in
 * {@link com.ealvatag.tag.id3.framebody.FrameBodySYTC}
 *
