...
import com.ealvatag.tag.EmptyFrameException;
import com.ealvatag.tag.InvalidDataTypeException;
import com.ealvatag.tag.InvalidFrameException;
import com.ealvatag.tag.InvalidFrameIdentifierException;
import com.ealvatag.tag.id3.framebody.AbstractID3v2FrameBody;
import com.ealvatag.tag.id3.framebody.FrameBodyDeprecated;
import com.ealvatag.tag.id3.framebody.FrameBodyUnsupported;
import com.ealvatag.tag.id3.valuepair.TextEncoding;
import com.ealvatag.utils.EqualsUtil;
...
public class ID3v22Frame extends AbstractID3v2Frame
{
    ...
    public ID3v22Frame(String identifier)
    {
        ...
        try
        {
            Class<AbstractID3v2FrameBody> c = (Class<AbstractID3v2FrameBody>) Class.forName("com.ealvatag.tag.id3.framebody.FrameBody" + bodyIdentifier);
     ...
     * @throws com.ealvatag.tag.InvalidFrameException
     */
