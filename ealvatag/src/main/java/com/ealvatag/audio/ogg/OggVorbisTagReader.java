 ...
 */
package com.ealvatag.audio.ogg;

import com.ealvatag.audio.exceptions.CannotReadException;
import com.ealvatag.audio.ogg.util.OggPageHeader;
import com.ealvatag.audio.ogg.util.VorbisHeader;
import com.ealvatag.audio.ogg.util.VorbisPacketType;
import com.ealvatag.logging.ErrorMessage;
import com.ealvatag.tag.Tag;
import com.ealvatag.tag.vorbiscomment.VorbisCommentReader;
...
{
    // Logger Object
    public static Logger logger = Logger.getLogger("com.ealvatag.audio.ogg");
