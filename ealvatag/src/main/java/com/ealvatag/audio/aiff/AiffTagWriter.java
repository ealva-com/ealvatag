...
import com.ealvatag.audio.aiff.chunk.AiffChunkSummary;
import com.ealvatag.audio.aiff.chunk.AiffChunkType;
...
import com.ealvatag.audio.iff.Chunk;
import com.ealvatag.audio.iff.ChunkHeader;
import com.ealvatag.audio.iff.ChunkSummary;
import com.ealvatag.audio.iff.IffHeaderChunk;
...
import static com.ealvatag.audio.iff.IffHeaderChunk.SIGNATURE_LENGTH;
import static com.ealvatag.audio.iff.IffHeaderChunk.SIZE_LENGTH;
...
{
    // Logger Object
    public static Logger logger = Logger.getLogger("com.ealvatag.audio.aiff");
    ...
    /**
     * Writes data as a {@link com.ealvatag.audio.aiff.chunk.AiffChunkType#TAG} chunk to the file.
     *
     * @param fc filechannel
