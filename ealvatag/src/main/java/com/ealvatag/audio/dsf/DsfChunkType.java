...
/**
 * Chunk types mark each {@link com.ealvatag.audio.iff.ChunkHeader}. They are <em>always</em> 4 ASCII chars long.
 *
 * @see com.ealvatag.audio.iff.Chunk
 */
public enum DsfChunkType
{
    ...
    /**
     * Get {@link com.ealvatag.audio.dsf.DsfChunkType} for code (e.g. "SSND").
     *
     * @param code chunk id
