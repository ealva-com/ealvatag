...
import static com.ealvatag.audio.dsf.DsdChunk.CHUNKSIZE_LENGTH;
...
{
    public static Logger logger = Logger.getLogger("com.ealvatag.audio.dsf.FmtChunk");
     ...
     *                       fields
     * @return an empty {@link com.ealvatag.audio.generic.GenericAudioHeader} if audioInfoChunk has less
