...
import com.ealvatag.audio.asf.data.AudioStreamChunk;
import com.ealvatag.audio.asf.data.MetadataContainer;
import com.ealvatag.audio.asf.data.MetadataDescriptor;
import com.ealvatag.audio.asf.io.*;
...
public class AsfFileReader extends AudioFileReader
{
     ...
     * Logger instance
     */
    private final static Logger LOGGER = Logger.getLogger("com.ealvatag.audio.asf");
     ...
     * (overridden)
     *
     * @see com.ealvatag.audio.generic.AudioFileReader#getEncodingInfo(java.io.RandomAccessFile)
     */
    @Override
     ...
     * (overridden)
     *
     * @see com.ealvatag.audio.generic.AudioFileReader#getTag(java.io.RandomAccessFile)
     */
    @Override
