...
import com.ealvatag.audio.asf.data.Chunk;
import com.ealvatag.audio.asf.data.ChunkContainer;
...
abstract class ChunkContainerReader<ChunkType extends ChunkContainer> implements ChunkReader
{
     ...
     * Logger
     */
    protected static final Logger LOGGER = Logger.getLogger("com.jaudiotabgger.audio"); //$NON-NLS-1$
