...
import com.ealvatag.audio.exceptions.ModifyVetoException;
...
public class ModificationHandler implements AudioFileModificationListener
{
     ...
     * (overridden)
     *
     * @see com.ealvatag.audio.generic.AudioFileModificationListener#fileModified(com.ealvatag.audio.AudioFile,
     *File)
     */
     ...
     * (overridden)
     *
     * @see com.ealvatag.audio.generic.AudioFileModificationListener#fileOperationFinished(File)
     */
     ...
     * (overridden)
     *
     * @see com.ealvatag.audio.generic.AudioFileModificationListener#fileWillBeModified(com.ealvatag.audio.AudioFile,
     *boolean)
     */
     ...
     * (overridden)
     *
     * @see com.ealvatag.audio.generic.AudioFileModificationListener#vetoThrown(com.ealvatag.audio.generic.AudioFileModificationListener,
     * com.ealvatag.audio.AudioFile,
     * com.ealvatag.audio.exceptions.ModifyVetoException)
     */
