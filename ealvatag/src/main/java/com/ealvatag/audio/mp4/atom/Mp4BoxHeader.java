 ...
 */
package com.ealvatag.audio.mp4.atom;

import com.ealvatag.audio.exceptions.InvalidBoxHeaderException;
...
{
    // Logger Object
    public static Logger logger = Logger.getLogger("com.ealvatag.audio.mp4.atom");
