 ...
 *
 * <p>This is not required by ealvatag, but its advantage over the default formatter is that all the format for a log
 ...
 * e.g java.util.logging.ConsoleHandler.formatter = com.ealvatag.logging.LogFormatter
 */
