...
public final class NullTagField implements TagField {
    ...
    @Override public void copyContent(final TagField field) {}

    @Override public String getId() {return "";}

    @Override public byte[] getRawContent() throws UnsupportedEncodingException {return new byte[0];}

    @Override public boolean isBinary() {return false;}

    @Override public void isBinary(final boolean b) {}

    @Override public boolean isCommon() {return false;}
