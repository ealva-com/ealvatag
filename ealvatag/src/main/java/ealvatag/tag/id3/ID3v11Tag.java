...
public class ID3v11Tag extends ID3v1Tag {
  ...
  @SuppressWarnings("unused") private static final int FIELD_TRACK_INDICATOR_LENGTH = 1;
  private static final int FIELD_TRACK_INDICATOR_POS = 125;

  @SuppressWarnings("unused") private static final int FIELD_TRACK_LENGTH = 1;
  ...
  @SuppressWarnings("unused") public void addTrack(String track) {
    setTrack(track);
  }
