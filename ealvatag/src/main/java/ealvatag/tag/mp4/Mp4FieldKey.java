...
public enum Mp4FieldKey {
  ...
  Mp4FieldKey(String issuer, String identifier, Mp4FieldType fieldType) {
    ...
    this.fieldName = BuilderHolder.makeFieldName(issuer, identifier);
  ...
  private static class BuilderHolder {
    ...
    private static String makeFieldName(@NotNull final String issuer, @NotNull final String identifier) {
