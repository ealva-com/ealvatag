...
public class StringFixedLength extends AbstractString {
    ...
    public void readByteArray(byte[] arr, int offset) throws InvalidDataTypeException {
        ...
        try {
            ...
            LOG.trace("Array length is:" + arr.length + "offset is:" + offset + "Size is:" + size);
    ...
    public byte[] writeByteArray() {
        ...
        try {
            ...
            LOG.warn("There was a problem writing the following StringFixedlength Field:" + value + ":" +
        ...
        if (dataBuffer != null) {
            ...
            LOG.warn("There was a serious problem writing the following StringFixedlength Field:" + value + ":" +
