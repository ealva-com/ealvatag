...
public class MetadataDescriptor implements Comparable<MetadataDescriptor>, Cloneable {
   ...
   */
  public MetadataDescriptor(final ContainerType type,
  ...
  public MetadataDescriptor createCopy() {
    final MetadataDescriptor result = new MetadataDescriptor(this.containerType,
                                                             this.name,
                                                             this.descriptorType,
                                                             this.streamNumber,
                                                             this.languageIndex);
  ...
  public boolean equals(final Object obj) {
    ...
    if (obj instanceof MetadataDescriptor) {
      if (obj == this) {
        ...
        result = other.getName().equals(getName()) && other.descriptorType == this.descriptorType &&
            other.languageIndex == this.languageIndex && other.streamNumber == this.streamNumber &&
   ...
   */
  int getCurrentAsfSize(final ContainerType type) {
        /*
  ...
  public void setBinaryValue(final byte[] data) throws IllegalArgumentException {
    this.containerType.assertConstraints(this.name,
                                         data,
                                         this.descriptorType,
                                         this.streamNumber,
                                         this.languageIndex);
   ...
   */
  void setLanguageIndex(final int language) {
   ...
   */
  void setQWordValue(final BigInteger value) throws IllegalArgumentException {
    if (value == null) {
  ...
  public void setQWordValue(final long value) {
    if (value < 0) {
      throw new IllegalArgumentException(
          "value out of range (0-" + MetadataDescriptor.QWORD_MAXVALUE.toString() + ")");
    }
   ...
   */
  void setStreamNumber(final int stream) {
  ...
  public String toString() {
    return getName() + " : " + new String[]{
        ...
        "WORD:",
        "GUID:"
    }[this.descriptorType] + getString() + " (language: " + this.languageIndex + " / stream: " + this.streamNumber +
        ")";
  }
   ...
   */
  int writeInto(final OutputStream out, final ContainerType contType) throws IOException {
