...
public class WavId3Chunk extends Chunk {
    public static Logger LOG = LoggerFactory.getLogger(WavId3Chunk.class);
    ...
    public boolean readChunk() throws IOException {
        ...
        try {
            ...
            LOG.info("Exception reading ID3 tag: " + e.getClass().getName() + ": " + e.getMessage());
            return false;
        }
        return true;
    }
