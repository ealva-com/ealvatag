...
class Mp4DrmsBox extends AbstractMp4Box {
    private static final Logger LOG = LoggerFactory.getLogger(Mp4DrmsBox.class);
    ...
    Mp4DrmsBox(final Mp4BoxHeader drmsBoxHeader,
        ...
        try {
            ...
            if (childHeaderMark != -1) {
                ...
                @SuppressWarnings("unused") Mp4EsdsBox esdsBox = new Mp4EsdsBox(childHeader,
                                                                                bufferedSource,
                                                                                audioHeader,
                                                                                EncoderType.DRM_AAC);
            }
        } catch (EOFException e) {
            LOG.debug("");  // TODO: 2/4/17
        }
    }
