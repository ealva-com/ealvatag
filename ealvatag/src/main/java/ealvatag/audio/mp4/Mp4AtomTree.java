...
public class Mp4AtomTree {
            ...
            while (fc.position() < fc.size()) {
                ...
                try {
                    ...
                    if (moovNode != null & mdatNode != null) {
                        ...
                        LOG.warn(ErrorMessage.NULL_PADDING_FOUND_AT_END_OF_MP4.getMsg(np.getFilePos()));
                        break;
                    } else {
                ...
                if (boxHeader.getId().equals(Mp4AtomIdentifier.MOOV.getFieldName())) {
                    ...
                    //and finish
                    if (moovNode != null & mdatNode != null) {
                        LOG.warn(ErrorMessage.ADDITIONAL_MOOV_ATOM_AT_END_OF_MP4.getMsg(
                                fc.position() - Mp4BoxHeader.HEADER_LENGTH));
                        break;
                    }
                    moovNode = newAtom;
                    ...
                    if (bytesRead < boxHeader.getDataLength()) {
                        String msg = ErrorMessage.ATOM_LENGTH_LARGER_THAN_DATA.getMsg(boxHeader.getId(),
     ...
     * @throws CannotReadException
     */
    public void buildChildrenOfNode(ByteBuffer moovBuffer, DefaultMutableTreeNode parentNode)
        ...
        while (moovBuffer.position() < ((startPos + parentBoxHeader.getDataLength()) - Mp4BoxHeader.HEADER_LENGTH)) {
            ...
            if (boxHeader != null) {
                ...
                LOG.trace("Atom " + boxHeader.getId() + " @ " + boxHeader.getFilePos() + " of size:" +
                                  boxHeader.getLength() + " ,ends @ " +
                                  (boxHeader.getFilePos() + boxHeader.getLength()));
