...
public class Mp4TagReader {
    ...
    // Logger Object
    public static Logger LOG = LoggerFactory.getLogger(Mp4TagReader.class);
    ...
    public Mp4Tag read(RandomAccessFile raf) throws CannotReadException, IOException {
        ...
        LOG.debug("headerlengthsays:" + length + "datalength:" + metadataBuffer.limit());
        int read = 0;
        LOG.debug("Started to read metadata fields at position is in metadata buffer:" + metadataBuffer.position());
        while (read < length) {
            //Read the boxHeader
            ...
            //wont get affected
            LOG.debug("Next position is at:" + metadataBuffer.position());
