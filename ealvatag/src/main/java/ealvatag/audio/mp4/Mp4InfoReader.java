...
public class Mp4InfoReader {
    private static Logger LOG = LoggerFactory.getLogger(Mp4InfoReader.class);
    ...
    public GenericAudioHeader read(RandomAccessFile raf) throws CannotReadException, IOException {
        ...
        */
        ...
        //Level 6-Searching for "stsd within "stbl" and process it direct data, dont think these are mandatory so
        // dont throw
    ...
    public GenericAudioHeader read(FileOperator fileOperator) throws CannotReadException, IOException {
        ...
        */
        ...
        //Build AtomTree to ensure it is valid, this means we can detect any problems early on
//        new Mp4AtomTree(raf, false); WHAT???????????????? What is it with all the early detection. Don't pay a penalty on read when I
// may never save changes to the tags. This causes huge memory allocation
        return info;
    }
