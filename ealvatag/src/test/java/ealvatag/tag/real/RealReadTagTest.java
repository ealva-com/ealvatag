...
public class RealReadTagTest {
    ...
    @Test public void test01() throws InvalidAudioFrameException, IOException, ReadOnlyFileException, TagException, CannotReadException {
        checkRealTag("test01.ra", "Temptation Rag", "Prince's Military Band", "1910 [Columbia A854]");
    }

    public void checkRealTag(String filename, String title, String artist, String comment)
    ...
    @Test public void test02() throws InvalidAudioFrameException, IOException, ReadOnlyFileException, TagException, CannotReadException {
        checkRealTag("test02.ra", "Dixieland Jass Band One Step", "Original Dixieland 'Jass' Band", "1917 [Victor 18255-A]");
    }

    @Test public void test03() throws InvalidAudioFrameException, IOException, ReadOnlyFileException, TagException, CannotReadException {
        checkRealTag("test03.ra", "Here Comes My Daddy Now", "Collins and Harlan", "1913 [Oxford 38528]");
    }

    @Test public void test04() throws InvalidAudioFrameException, IOException, ReadOnlyFileException, TagException, CannotReadException {
        checkRealTag("test04.ra", "A Cat-Astrophe", "Columbia Orchestra", "1919 [Columbia A2855]");
    }

    @Test public void test05ra() throws InvalidAudioFrameException, IOException, ReadOnlyFileException, TagException, CannotReadException {
    ...
    @Test public void test05rm() throws InvalidAudioFrameException, IOException, ReadOnlyFileException, TagException, CannotReadException {
    ...
    @Test public void test06() throws InvalidAudioFrameException, IOException, ReadOnlyFileException, TagException, CannotReadException {
        checkRealTag("test06.rm", "No Trouble But You", "Ben Bernie & His Hotel Roosevelt Orchestra", "1926 (Brunswick 3171-A)");
    }

    @Test public void test07() throws InvalidAudioFrameException, IOException, ReadOnlyFileException, TagException, CannotReadException {
    ...
    @Test public void test08() throws InvalidAudioFrameException, IOException, ReadOnlyFileException, TagException, CannotReadException {
    ...
    @Test public void test09() throws InvalidAudioFrameException, IOException, ReadOnlyFileException, TagException, CannotReadException {
        checkRealTag("test09.rm", "Until Today", "Fletcher Henderson and his Orchestra", "1936 (Victor 25373-B)");
    }

    @Test public void test10() throws InvalidAudioFrameException, IOException, ReadOnlyFileException, TagException, CannotReadException {
