...
import ealvatag.tag.id3.framebody.FrameBodyTSOA;
import ealvatag.tag.id3.framebody.FrameBodyTSOATest;
import ealvatag.tag.id3.framebody.FrameBodyXSOA;
import ealvatag.tag.id3.framebody.FrameBodyXSOATest;
...
public class FrameTSOATest {
    ...
    @Test public void testCreateID3v24Frame() {
        ...
        Assert.assertEquals(ID3v24Frames.FRAME_ID_ALBUM_SORT_ORDER, frame.getIdentifier());
    ...
    @Test public void testCreateID3v23ITunesFrame() {
        ...
        Assert.assertNull(exceptionCaught);
        Assert.assertEquals(ID3v23Frames.FRAME_ID_V3_ALBUM_SORT_ORDER_ITUNES, frame.getIdentifier());
        Assert.assertEquals(TextEncoding.ISO_8859_1, fb.getTextEncoding());
    ...
    @Test public void testCreateID3v23MusicBrainzFrame() {
        ...
        Assert.assertNull(exceptionCaught);
        Assert.assertEquals(ID3v23Frames.FRAME_ID_V3_ALBUM_SORT_ORDER_MUSICBRAINZ, frame.getIdentifier());
        Assert.assertEquals(TextEncoding.ISO_8859_1, fb.getTextEncoding());
        Assert.assertTrue(ID3v23Frames.getInstanceOf().isExtensionFrames(frame.getIdentifier()));
        Assert.assertFalse(ID3v23Frames.getInstanceOf().isSupportedFrames(frame.getIdentifier()));
        Assert.assertEquals(FrameBodyTSOATest.ALBUM_SORT, fb.getText());
    ...
    @Test public void testCreateID3v22Frame() {
        ...
        Assert.assertNull(exceptionCaught);
        Assert.assertEquals(ID3v22Frames.FRAME_ID_V2_ALBUM_SORT_ORDER_ITUNES, frame.getIdentifier());
        Assert.assertEquals(TextEncoding.ISO_8859_1, fb.getTextEncoding());
    ...
    @Test public void testConvertV24ToV23() throws Exception {
        ...
        FrameBodyTSOA body = (FrameBodyTSOA)frame.getBody();
        Assert.assertEquals(TextEncoding.ISO_8859_1, body.getTextEncoding());
        Assert.assertEquals(FrameBodyTSOATest.ALBUM_SORT, body.getText());
    }
