...
import ealvatag.tag.id3.framebody.FrameBodyTSO2;
import ealvatag.tag.id3.framebody.FrameBodyTSO2Test;
...
public class FrameTSO2Test {
    ...
    @Test public void testCreateID3v24Frame() {
        ...
        Assert.assertEquals(ID3v24Frames.FRAME_ID_ALBUM_ARTIST_SORT_ORDER_ITUNES, frame.getIdentifier());
        Assert.assertEquals(TextEncoding.ISO_8859_1, frame.getBody().getTextEncoding());
        Assert.assertTrue(ID3v24Frames.getInstanceOf().isExtensionFrames(frame.getIdentifier()));
        Assert.assertFalse(ID3v24Frames.getInstanceOf().isSupportedFrames(frame.getIdentifier()));
        Assert.assertEquals(FrameBodyTSO2Test.ALBUM_ARTIST_SORT, ((FrameBodyTSO2)frame.getBody()).getText());
    }
    ...
    @Test public void testCreateID3v23Frame() {
        ...
        Assert.assertNull(exceptionCaught);
        Assert.assertEquals(ID3v23Frames.FRAME_ID_V3_ALBUM_ARTIST_SORT_ORDER_ITUNES, frame.getIdentifier());
        Assert.assertEquals(TextEncoding.ISO_8859_1, frame.getBody().getTextEncoding());
    ...
    @Test public void testCreateID3v22Frame() {
        ...
        Assert.assertNull(exceptionCaught);
        Assert.assertEquals(ID3v22Frames.FRAME_ID_V2_ALBUM_ARTIST_SORT_ORDER_ITUNES, frame.getIdentifier());
        Assert.assertEquals(TextEncoding.ISO_8859_1, frame.getBody().getTextEncoding());
    ...
    @Test public void testSaveToFile() throws Exception {
        File testFile = TestUtil.copyAudioToTmp("testV1.mp3", new File("test1017.mp3"));
    ...
    @Test public void testConvertV24ToV23() throws Exception {
        File testFile = TestUtil.copyAudioToTmp("testV1.mp3", new File("test1018.mp3"));
        MP3File mp3File = new MP3File(testFile);
        ...
        FrameBodyTSO2 body = (FrameBodyTSO2)frame.getBody();
        Assert.assertEquals(TextEncoding.ISO_8859_1, body.getTextEncoding());
        Assert.assertEquals(FrameBodyTSO2Test.ALBUM_ARTIST_SORT, body.getText());
    }

    @Test public void testConvertV24ToV22() throws Exception {
        File testFile = TestUtil.copyAudioToTmp("testV1.mp3", new File("test1019.mp3"));
        MP3File mp3File = new MP3File(testFile);
    ...
    @Test public void testConvertV23ToV22() throws Exception {
        File testFile = TestUtil.copyAudioToTmp("testV1.mp3", new File("test1020.mp3"));
        MP3File mp3File = new MP3File(testFile);
    ...
    @Test public void testConvertV22ToV24() throws Exception {
        File testFile = TestUtil.copyAudioToTmp("testV1.mp3", new File("test1021.mp3"));
        MP3File mp3File = new MP3File(testFile);
