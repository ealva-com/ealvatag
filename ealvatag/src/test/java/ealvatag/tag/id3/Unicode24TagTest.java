...
public class Unicode24TagTest {
    ...
    @Test public void testCreateISO8859EncodedSizeTerminatedString() throws Exception {
        File testFile = TestUtil.copyAudioToTmp("testV1.mp3", new File("testISO8859.mp3"));
    ...
    @Test public void testCreateUTF16BOMLEEncodedSizeTerminatedString() throws Exception {
        File testFile = TestUtil.copyAudioToTmp("testV1.mp3", new File("testutf16bomle.mp3"));
        MP3File mp3File = new MP3File(testFile);
    ...
    @Test public void testCreateUTF16BOMBEEncodedSizeTerminatedString() throws Exception {
        ...
        File testFile = TestUtil.copyAudioToTmp("testV1.mp3", new File("testutf16bombe.mp3"));
        MP3File mp3File = new MP3File(testFile);
     ...
     * as UTf16 by default
     */
    @Test public void testCreateUTF16BOMLEAutoEncodedSizeTerminatedString() throws Exception {
        File testFile = TestUtil.copyAudioToTmp("testV1.mp3", new File("testutf16-2.mp3"));
        MP3File mp3File = new MP3File(testFile);
     ...
     */
    @Test public void testCreateUTF8AutoEncodedSizeTerminatedString() throws Exception {
        File testFile = TestUtil.copyAudioToTmp("testV1.mp3", new File("testutf8.mp3"));
        MP3File mp3File = new MP3File(testFile);
    ...
    @Test public void testCreateUTF16BEEncodedSizeTerminatedString() throws Exception {
        File testFile = TestUtil.copyAudioToTmp("testV1.mp3", new File("testutf16be.mp3"));
        MP3File mp3File = new MP3File(testFile);
    ...
    @Test public void testCreateUTF8EncodedSizeTerminatedString() throws Exception {
        File testFile = TestUtil.copyAudioToTmp("testV1.mp3", new File("testutf8enc.mp3"));
        MP3File mp3File = new MP3File(testFile);
    ...
    @Test public void testv24TagsWithUTF8EncodingMaintainedOnSave() throws Exception {
        File testFile = TestUtil.copyAudioToTmp("issue109-2.id3", "testV1.mp3");
    ...
    @Test public void testv24TagsWithUTF8OverriddenByDefaultOnSave() throws Exception {
        File testFile = TestUtil.copyAudioToTmp("issue109-2.id3", "testV1.mp3");
    ...
    @Test public void testv24TagsWithUTF8OverriddenByDefaultsOnSave() throws Exception {
        File testFile = TestUtil.copyAudioToTmp("issue109-2.id3", "testV1.mp3");
