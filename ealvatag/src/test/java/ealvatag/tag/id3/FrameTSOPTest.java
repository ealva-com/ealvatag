...
import ealvatag.tag.id3.framebody.FrameBodyTSOP;
import ealvatag.tag.id3.framebody.FrameBodyTSOPTest;
import ealvatag.tag.id3.framebody.FrameBodyXSOP;
import ealvatag.tag.id3.framebody.FrameBodyXSOPTest;
...
public class FrameTSOPTest {
    ...
    @Test public void testCreateID3v24Frame() {
        ...
        Assert.assertEquals(ID3v24Frames.FRAME_ID_ARTIST_SORT_ORDER, frame.getIdentifier());
    ...
    @Test public void testCreateID3v23ITunesFrame() {
        ...
        Assert.assertNull(exceptionCaught);
        Assert.assertEquals(ID3v23Frames.FRAME_ID_V3_ARTIST_SORT_ORDER_ITUNES, frame.getIdentifier());
        Assert.assertEquals(TextEncoding.ISO_8859_1, fb.getTextEncoding());
    ...
    @Test public void testCreateID3v23MusicBrainzFrame() {
        ...
        Assert.assertNull(exceptionCaught);
        Assert.assertEquals(ID3v23Frames.FRAME_ID_V3_ARTIST_SORT_ORDER_MUSICBRAINZ, frame.getIdentifier());
        Assert.assertEquals(TextEncoding.ISO_8859_1, fb.getTextEncoding());
        Assert.assertTrue(ID3v23Frames.getInstanceOf().isExtensionFrames(frame.getIdentifier()));
        Assert.assertFalse(ID3v23Frames.getInstanceOf().isSupportedFrames(frame.getIdentifier()));
        Assert.assertEquals(FrameBodyTSOPTest.ARTIST_SORT, fb.getText());
    ...
    @Test public void testCreateID3v22Frame() {
        ...
        Assert.assertNull(exceptionCaught);
        Assert.assertEquals(ID3v22Frames.FRAME_ID_V2_ARTIST_SORT_ORDER_ITUNES, frame.getIdentifier());
        Assert.assertEquals(TextEncoding.ISO_8859_1, fb.getTextEncoding());
    ...
    @Test public void testConvertV24ToV23() throws Exception {
        ...
        FrameBodyTSOP body = (FrameBodyTSOP)frame.getBody();
        Assert.assertEquals(TextEncoding.ISO_8859_1, body.getTextEncoding());
        Assert.assertEquals(FrameBodyTSOPTest.ARTIST_SORT, body.getText());
    }

    @Test public void testConvertV24ToV22() throws Exception {
        File testFile = TestUtil.copyAudioToTmp("testV1.mp3", new File("test1006.mp3"));
        MP3File mp3File = new MP3File(testFile);
    ...
    @Test public void testConvertV23ITunesToV22() throws Exception {
        File testFile = TestUtil.copyAudioToTmp("testV1.mp3", new File("test1007.mp3"));
        MP3File mp3File = new MP3File(testFile);
    ...
    @Test public void testConvertV23MusicBrainzToV22() throws Exception {
        File testFile = TestUtil.copyAudioToTmp("testV1.mp3", new File("test1008.mp3"));
        MP3File mp3File = new MP3File(testFile);
    ...
    @Test public void testConvertV22ToV24() throws Exception {
        File testFile = TestUtil.copyAudioToTmp("testV1.mp3", new File("test1009.mp3"));
        MP3File mp3File = new MP3File(testFile);
