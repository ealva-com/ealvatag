 ...
 * Date: 07-Dec-2007
 */
public class WavMetadataTwonkyTrckTest {
    ...
    @Test public void testModifyFileMetadataSaveBoth() {
        ...
        try {
            ...
            Assert.assertEquals(926264L, tag.getInfoTag().getStartLocationInFile().longValue());
            Assert.assertEquals(926562L, tag.getInfoTag().getEndLocationInFile().longValue());
            Assert.assertEquals(290L, tag.getInfoTag().getSizeOfTag());
            Assert.assertEquals(10L, tag.getSizeOfID3TagOnly()); //Because have SAVE BOTH option but nothign added to ID3 save empty ID3tag
            Assert.assertEquals(926562L, tag.getStartLocationInFileOfId3Chunk());
    ...
    @Test public void testModifyFileWithMoreMetadataSaveBothInfoThenId3() {
        ...
        try {
            ...
            Assert.assertEquals(926264L, tag.getInfoTag().getStartLocationInFile().longValue());
            Assert.assertEquals(926710L, tag.getInfoTag().getEndLocationInFile().longValue());
            Assert.assertEquals(438L, tag.getInfoTag().getSizeOfTag());
            Assert.assertEquals(10L, tag.getSizeOfID3TagOnly()); //Because have SAVE BOTH option but nothign added to ID3 save empty ID3tag
            Assert.assertEquals(926710L, tag.getStartLocationInFileOfId3Chunk());
            Assert.assertEquals(18L, tag.getSizeOfID3TagIncludingChunkHeader());
            Assert.assertEquals(926728L, testFile.length());
    ...
    @Test public void testModifyFileWithMoreMetadataSaveBothId3ThenInfo() {
        ...
        try {
            ...
            Assert.assertEquals(926728L, tag.getInfoTag().getEndLocationInFile().longValue());
            Assert.assertEquals(438L, tag.getInfoTag().getSizeOfTag());
            Assert.assertEquals(926728L, testFile.length());
            ...
            Assert.assertEquals(926728L, tag.getInfoTag().getEndLocationInFile().longValue());
            Assert.assertEquals(438L, tag.getInfoTag().getSizeOfTag());
            Assert.assertEquals(926668L, testFile.length());
    ...
    @Test public void testModifyFileMetadataSaveExistingActiveId3Info() {
        ...
        try {
            ...
            Assert.assertEquals(298L, tag.getInfoTag().getSizeOfTag());
            Assert.assertEquals(26L, tag.getSizeOfID3TagOnly());
            Assert.assertEquals(926570L, tag.getStartLocationInFileOfId3Chunk());
    ...
    @Test public void testWriteNumberedOddSaveBoth() {
        ...
        try {
            ...
            Assert.assertEquals(926508L, tag.getInfoTag().getStartLocationInFile().longValue());
            Assert.assertEquals(926684L, tag.getInfoTag().getEndLocationInFile().longValue());
            Assert.assertEquals(168L, tag.getInfoTag().getSizeOfTag());
            ...
            Assert.assertEquals(244L, tag.getSizeOfID3TagIncludingChunkHeader());
            Assert.assertEquals(926508L, tag.getInfoTag().getStartLocationInFile().longValue());
            Assert.assertEquals(926690L, tag.getInfoTag().getEndLocationInFile().longValue());
            Assert.assertEquals(174L, tag.getInfoTag().getSizeOfTag());
